...
> **Status:** Phase 1 complete — baseline comparison done. Phase 2 (novel contribution) in progress.
> **Working directory:** `/home/salty-sexyyy/ce-hfl-offloading/`
...
2. [The Two Base Papers](#2-the-two-base-papers)
3. [The Gap We Are Filling](#3-the-gap-we-are-filling)
4. [Our Novel Contribution](#4-our-novel-contribution)
5. [Why It Is Novel — Literature Evidence](#5-why-it-is-novel--literature-evidence)
...
10. [Experiment Plan & Baselines](#10-experiment-plan--baselines)
...
## 5. Why It Is Novel — Literature Evidence
...
- [ ] Related Work: cite all papers in Section 14
- [ ] System Model: formalize equations from Section 7
...
2. Zhun Li et al. "On Energy Optimization for Hierarchical Federated Learning With Delay Constraint Through Node Cooperation." *IEEE Internet of Things Journal*, Vol. 11, No. 9, May 2024. **(Paper 2 — Base)**
...
4. Wang et al. "Adaptive Federated Learning in Resource Constrained Edge Computing." 2019. https://arxiv.org/pdf/2203.12163 — *Analytical (not RL) adaptive aggregation interval, flat FL, no energy cost model.*
...
10. "Task Scheduling in Edge Computing Environments (HFL-Cluster)." *WhiteRose*, 2024. https://eprints.whiterose.ac.uk/id/eprint/234705/ — *RL for task scheduling in clusters using FL, not FL aggregation round scheduling.*

11. "Optimal Resource Management for Hierarchical Federated Learning." *arXiv*, 2023. https://arxiv.org/pdf/2305.01953 — *Resource allocation in HFL, analytical, not RL-based timing.*

12. "Hierarchical Federated Learning: Approaches and Open Problems." *IEEE Access*, 2024. https://ieeexplore.ieee.org/iel8/6287639/10820123/11224517.pdf — *Survey, no RL-based aggregation scheduler.*
